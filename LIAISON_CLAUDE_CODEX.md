...
**Dernière mise à jour :** 2026-06-15 — par **Claude** (refonte variantes pré-tarifées — EN LOCAL, NON poussé)
**Branche :** `main` · **Dernier commit poussé connu :** `5f260c8`

> ⚠️ **Codex : modifs EN LOCAL non commitées** (Alan n'a pas encore demandé de push).
> Sujet : abandon de la 2e ligne « Frais d'impression » → **variantes Shopify pré-tarifées**
> (UNE seule ligne panier, prix d'impression inclus). Détail en §1 et §6.
